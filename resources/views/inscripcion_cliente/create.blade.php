...
<html lang="en">
    <head>
        ...
        <title>Create Inscripcion_cliente</title>
    </head>
    <body>
        <div class = 'container'>
            <h1>Create Inscripcion_cliente</h1>
            ...
            <br>
            <form method = 'POST' action = 'http://localhost/php/railiz/transporte/public/inscripcion_cliente'>
                ...
                <div class="form-group">
                    ...
                    <input id="apellido_estudiante" name = "apellido_estudiante" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="calle_ruta" name = "calle_ruta" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="casa_ruta">casa_ruta</label>
                    <input id="casa_ruta" name = "casa_ruta" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="colegio_estudiante">colegio_estudiante</label>
                    <input id="colegio_estudiante" name = "colegio_estudiante" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="telefono_estudiante" name = "telefono_estudiante" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="nombre_representante">nombre_representante</label>
                    <input id="nombre_representante" name = "nombre_representante" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="apellido_representante">apellido_representante</label>
                    <input id="apellido_representante" name = "apellido_representante" type="text" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="telefono_representante" name = "telefono_representante" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="fecha_inscripcion">fecha_inscripcion</label>
                    <input id="fecha_inscripcion" name = "fecha_inscripcion" type="text" class="form-control">
                </div>
                
                <div class="form-group">
                    <label for="contrato_inscripcion">contrato_inscripcion</label>
                    <input id="contrato_inscripcion" name = "contrato_inscripcion" type="text" class="form-control">
                </div>
