...
<html lang="en">
    <head>
        ...
        <title>Edit Mensualidades_transportista</title>
    </head>
    <body>
        <div class = 'container'>
            <h1>Edit Mensualidades_transportista</h1>
            ...
            <br>
            <form method = 'POST' action = 'http://localhost/php/railiz/transporte/public/mensualidades_transportista/{{$mensualidades_transportista->id}}/update'>
