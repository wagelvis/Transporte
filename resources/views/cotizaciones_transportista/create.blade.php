...
<html lang="en">
    <head>
        ...
        <title>Create Cotizaciones_transportista</title>
    </head>
    <body>
        <div class = 'container'>
            <h1>Create Cotizaciones_transportista</h1>
            ...
            <br>
            <form method = 'POST' action = 'http://localhost/php/railiz/transporte/public/cotizaciones_transportista'>
