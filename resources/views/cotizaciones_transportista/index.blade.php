...
@section('content')
        <div class = 'container'>
            <div class="page-header">
                <h1>Cotizaciones <small> - Índice de Registros</small></h1>
            </div>
            <form class = 'col s3' method = 'get' action = './cotizaciones_transportista/create'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center">
                            <a href = './cotizaciones_transportista/{{$value->id}}' class = 'viewShow btn btn-warning btn-sm' title="Ver"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
                            <a href = './cotizaciones_transportista/{{$value->id}}/edit' class = 'viewEdit btn btn-primary btn-sm' title="Editar"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></i></a>
