...
<html lang="en">
    <head>
        ...
        <title>Edit Registro_cliente</title>
    </head>
    <body>
        <div class = 'container'>
            <h1>Edit Registro_cliente</h1>
            ...
            <br>
            <form method = 'POST' action = 'http://localhost/php/railiz/transporte/public/registro_cliente/{{$registro_cliente->id}}/update'>
                ...
                <div class="form-group">
                    ...
                    <input id="email_usuario" name = "email_usuario" type="text" class="form-control" value="{{$registro_cliente->email_usuario}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="contrase&ntilde;a" name = "contrase&ntilde;a" type="text" class="form-control" value="{{$registro_cliente->contrase&ntilde;a}}">
                </div>
                
                <div class="form-group">
                    <label for="confirmacion_contrase&ntilde;a">confirmacion_contrase&ntilde;a</label>
                    <input id="confirmacion_contrase&ntilde;a" name = "confirmacion_contrase&ntilde;a" type="text" class="form-control" value="{{$registro_cliente->confirmacion_contrase&ntilde;a}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="fecha_registro" name = "fecha_registro" type="text" class="form-control" value="{{$registro_cliente->fecha_registro}}">
                </div>
